...
function Dashboard_Contacts_Modif() {
 ...
 const handleSubmit = (event) => {
   ...
   if (formIsValid) {
     ...
     const confirmSubmit = window.confirm(
        "Êtes-vous sûr de vouloir modifier ce contact?"
      );

      if (confirmSubmit) {
        let url = `https://quentin.hugoorickx.tech/contact/${id}`;
        let options = {
          method: "PATCH",
 ...
 export default Dashboard_Contacts_Modif;   